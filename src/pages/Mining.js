...
const [dots, setDots] = useState([]);
  ...
  return (
    <div className="bg-[#0d0d0d] text-gray-200 min-h-screen p-4 font-sans flex flex-col items-center">
      ...
      <div className="bg-[#181818] p-6 mt-6 rounded-xl border border-teal-500 w-full max-w-md text-center">
      ...
      <div className="flex justify-between w-full max-w-md mt-6 p-4 border border-teal-500 rounded-lg text-center">
        ...
        <div className="flex-1 p-4">
          ...
          <p className="text-teal-300 text-lg font-bold flex items-center justify-center">
            1 <span className="text-yellow-400 mx-1">&#11088;</span> ≈ 1.62 <Gem className="w-5 h-5 text-teal-400 ml-1" />
          </p>
        </div>
      </div>
